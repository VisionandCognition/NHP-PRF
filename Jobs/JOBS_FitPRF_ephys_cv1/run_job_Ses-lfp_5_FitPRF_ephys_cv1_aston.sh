...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_ephys.sh \
	...
	css_ephys 1 ephys_cv1 /home/pcklink/PRF/Logs/ $TMPDIR/PRF/ \
	 |& tee $TMPDIR/PRF/Logs/Log_aston_lfp_5_css_ephys_xval1.txt

cp $TMPDIR/PRF/Logs/Log_aston_lfp_5_css_ephys_xval1.txt $HOME/PRF/Logs/
exit $?
