...
# INFO: FitPRF_csshrf_cv1_dhrf_AllSessions-avg-cv_31:45
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg.sh \
	...
	css_hrf 1 csshrf_cv1_dhrf /home/pcklink/PRF/Logs/ $TMPDIR/PRF/ \
	 |& tee $TMPDIR/PRF/Logs/Log_eddy_AllSessions-avg-cv_31:45_defaultHRF_css_hrf_xval1.txt

cp $TMPDIR/PRF/Logs/Log_eddy_AllSessions-avg-cv_31:45_defaultHRF_css_hrf_xval1.txt $HOME/PRF/Logs/
exit $?
