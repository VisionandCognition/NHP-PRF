...
# INFO: FitPRF_linear_hrf_cv1_neggain_mua_2
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_ephys.sh \
	...
	linear_hrf 1 linear_hrf_cv1_neggain /home/pcklink/PRF/Logs/ $TMPDIR/PRF/ \
	 |& tee $TMPDIR/PRF/Logs/Log_aston_mua_2_linear_hrf_xval1.txt

cp $TMPDIR/PRF/Logs/Log_aston_mua_2_linear_hrf_xval1.txt $HOME/PRF/Logs/
exit $?
