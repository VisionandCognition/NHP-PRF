...
# INFO: FitPRF_csshrf_cv0_dhrf_AllSessions-avg-cv0_29:42
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg.sh \
	...
	css_hrf 1 csshrf_cv0_dhrf /home/pcklink/PRF/Logs/ $TMPDIR/PRF/ \
	 |& tee $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-cv0_29:42_defaultHRF_css_hrf_xval1.txt

cp $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-cv0_29:42_defaultHRF_css_hrf_xval1.txt $HOME/PRF/Logs/
exit $?
