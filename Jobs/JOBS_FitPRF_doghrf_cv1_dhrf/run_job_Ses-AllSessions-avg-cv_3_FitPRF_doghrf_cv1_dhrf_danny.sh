...
# INFO: FitPRF_doghrf_cv1_dhrf_AllSessions-avg-cv_29:42
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg.sh \
	...
	dog_hrf 1 doghrf_cv1_dhrf /home/pcklink/PRF/Logs/ $TMPDIR/PRF/ \
	 |& tee $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-cv_29:42_defaultHRF_dog_hrf_xval1.txt

cp $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-cv_29:42_defaultHRF_dog_hrf_xval1.txt $HOME/PRF/Logs/
exit $?
