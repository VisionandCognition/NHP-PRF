...
# INFO: FitPRF_cv_mhrf_AllSessions-avg-cv_46:60
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg.sh \
	...
	$TMPDIR/PRF/ |& tee $TMPDIR/PRF/Logs/Log_eddy_AllSessions-avg-cv_46:60_HRF_monkey.txt

cp $TMPDIR/PRF/Logs/Log_eddy_AllSessions-avg-cv_46:60_HRF_monkey.txt $HOME/PRF/Logs/
exit $?
