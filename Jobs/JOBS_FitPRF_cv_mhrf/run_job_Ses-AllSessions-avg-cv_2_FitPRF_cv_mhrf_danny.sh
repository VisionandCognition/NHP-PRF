...
# INFO: FitPRF_cv_mhrf_AllSessions-avg-cv_15:28
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg.sh \
	...
	$TMPDIR/PRF/ |& tee $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-cv_15:28_HRF_monkey.txt

cp $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-cv_15:28_HRF_monkey.txt $HOME/PRF/Logs/
exit $?
