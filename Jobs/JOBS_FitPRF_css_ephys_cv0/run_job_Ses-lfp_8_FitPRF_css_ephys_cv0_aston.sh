...
# INFO: FitPRF_css_ephys_cv0_lfp_8
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_ephys.sh \
	...
	css_ephys 0 css_ephys_cv0 /home/pcklink/PRF/Logs/ $TMPDIR/PRF/ \
	 |& tee $TMPDIR/PRF/Logs/Log_aston_lfp_8_css_ephys_xval0.txt

cp $TMPDIR/PRF/Logs/Log_aston_lfp_8_css_ephys_xval0.txt $HOME/PRF/Logs/
exit $?
