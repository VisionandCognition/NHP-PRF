...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg.sh \
	...
	lin_hrf 1 linhrf_cv0_mhrf /home/pcklink/PRF/Logs/ $TMPDIR/PRF/ \
	 |& tee $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-cv0_01:14_HRF_monkey_lin_hrf_xval1.txt

cp $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-cv0_01:14_HRF_monkey_lin_hrf_xval1.txt $HOME/PRF/Logs/
exit $?
