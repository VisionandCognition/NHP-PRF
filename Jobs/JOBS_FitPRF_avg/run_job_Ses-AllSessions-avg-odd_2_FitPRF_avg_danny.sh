...
# INFO: FitPRF_avg_AllSessions-avg-odd_15:28
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg.sh \
	pRF_FitModel_LISA_avg danny AllSessions-avg-odd 15:28 HRF_monkey [] \
	/home/pcklink/PRF/Logs/ \
	$TMPDIR/PRF/ |& tee $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-odd_15:28_HRF_monkey.txt

cp $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-odd_15:28_HRF_monkey.txt $HOME/PRF/Logs/
exit $?
