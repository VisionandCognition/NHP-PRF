...
# INFO: FitPRF_avg_AllSessions-avg-even_01:14
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg.sh \
	pRF_FitModel_LISA_avg danny AllSessions-avg-even 01:14 HRF_monkey [] \
	/home/pcklink/PRF/Logs/ \
	$TMPDIR/PRF/ |& tee $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-even_01:14_HRF_monkey.txt

cp $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-even_01:14_HRF_monkey.txt $HOME/PRF/Logs/
exit $?
