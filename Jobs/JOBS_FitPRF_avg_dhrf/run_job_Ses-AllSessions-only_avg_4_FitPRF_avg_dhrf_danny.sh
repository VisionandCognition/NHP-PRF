...
# INFO: FitPRF_avg_dhrf_AllSessions-only_avg_43:56
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg_dhrf.sh \
	pRF_FitModel_LISA_avg danny AllSessions-only_avg 43:56 defaultHRF [] \
	/home/pcklink/PRF/Logs/ \
	$TMPDIR/PRF/ |& tee $TMPDIR/PRF/Logs/Log_danny_AllSessions-only_avg_43:56_defaultHRF.txt

cp $TMPDIR/PRF/Logs/Log_danny_AllSessions-only_avg_43:56_defaultHRF.txt $HOME/PRF/Logs/
exit $?
