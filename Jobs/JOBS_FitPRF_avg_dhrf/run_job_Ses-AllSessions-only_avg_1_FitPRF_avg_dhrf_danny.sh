...
# INFO: FitPRF_avg_dhrf_AllSessions-only_avg_01:14
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg_dhrf.sh \
	pRF_FitModel_LISA_avg danny AllSessions-only_avg 01:14 defaultHRF [] \
	/home/pcklink/PRF/Logs/ \
	$TMPDIR/PRF/ |& tee $TMPDIR/PRF/Logs/Log_danny_AllSessions-only_avg_01:14_defaultHRF.txt

cp $TMPDIR/PRF/Logs/Log_danny_AllSessions-only_avg_01:14_defaultHRF.txt $HOME/PRF/Logs/
exit $?
