...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg.sh \
	pRF_FitModel_LISA_cv0_neggain danny AllSessions-avg-cv0 29:42 HRF_monkey [] \
	linear_hrf 1 linhrf_cv0_mhrf_neggain /home/pcklink/PRF/Logs/ $TMPDIR/PRF/ \
	 |& tee $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-cv0_29:42_HRF_monkey_linear_hrf_xval1.txt

cp $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-cv0_29:42_HRF_monkey_linear_hrf_xval1.txt $HOME/PRF/Logs/
exit $?
