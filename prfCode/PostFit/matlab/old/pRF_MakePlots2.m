...
ECC = load_nii(fullfile(respath,'AveragedResults_SD',['Thr_' num2str(Thr)], ...
    'nii',['MeanEccentricity_th' num2str(Thr) '_pv' num2str(pVox) '.nii']));
ANG = load_nii(fullfile(respath,'AveragedResults_SD',['Thr_' num2str(Thr)], ...
    'nii',['MeanAngle_th' num2str(Thr) '_pv' num2str(pVox) '.nii']));
RFS = load_nii(fullfile(respath,'AveragedResults_SD',['Thr_' num2str(Thr)], ...
