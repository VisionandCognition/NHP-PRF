...
load(fullfile(base,'FitResults','MultiModal',CVMODE{1},'LFP_Struct'));
LFP1=LFP;
load(fullfile(base,'FitResults','MultiModal',CVMODE{2},'LFP_Struct'));
LFP2=LFP;
fprintf('Done!\n')
xvalsel = 'RTEmx';
...
for  fb=1:5
    ...
    %% R2 =================================================================
    aR1 = LFP1.RTE.R2(strcmp(...
        LFP1.RTE.Monkey,monkey) & ...
        strcmp(LFP1.RTE.Model,model1) & ...
        strcmp(LFP1.RTE.SigType,SigTypes{fb}) ...
        );
    
    aR2 = LFP2.(xvalsel).R2(strcmp(...
        LFP2.(xvalsel).Monkey,monkey) & ...
        strcmp(LFP2.(xvalsel).Model,model2) & ...
        strcmp(LFP2.RTEmx.SigType,SigTypes{fb}) ...
        );
    
    figure;
    subplot(1,2,1);
    histogram(aR1,0:100);
    title([CVMODE{1}  ' (' SigTypes{fb} ')']);
    subplot(1,2,2);
    histogram(aR2,0:100);
    title([CVMODE{2} '(' SigTypes{fb} ')']);
    ...
    aSz1 = LFP1.RTE.rfs(...
        strcmp(LFP1.RTE.Monkey,monkey) & ...
        strcmp(LFP1.RTE.Model,model1) & ...
        strcmp(LFP1.RTE.SigType,SigTypes{fb}) ...
        );
    
    aSz2 = LFP2.(xvalsel).rfs(...
        strcmp(LFP2.(xvalsel).Monkey,monkey) & ...
        strcmp(LFP2.(xvalsel).Model,model2) & ...
        strcmp(LFP2.RTEmx.SigType,SigTypes{fb}) ...
        );
