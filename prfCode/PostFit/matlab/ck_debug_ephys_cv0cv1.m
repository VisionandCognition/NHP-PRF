...
load(fullfile(base,'FitResults','MultiModal',CVMODE{1},'MUA_Struct'));
MUA1=MUA;
...
aR1 = MUA1.RTE.R2(strcmp(...
    MUA1.RTE.Monkey,monkey) & ...
    strcmp(MUA1.RTE.Model,model1)...
    );

aR2 = MUA2.RTEmx.R2(strcmp(...
    MUA2.RTEmx.Monkey,monkey) & ...
    strcmp(MUA2.RTEmx.Model,model2)...
    );
...
aSz1 = MUA1.RTE.rfs(...
    strcmp(MUA1.RTE.Monkey,monkey) & ...
    strcmp(MUA1.RTE.Model,model1)...
    );

aSz2 = MUA2.RTEmx.rfs(...
    strcmp(MUA2.RTEmx.Monkey,monkey) & ...
    strcmp(MUA2.RTEmx.Model,model2)...
    );
