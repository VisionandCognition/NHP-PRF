MONKEY = {'Lick','Aston'};
SESS={'20180807_B2','20191203_B2','20191203_B3','20191203_B3';...
...
for m=2:length(MONKEY)
    fprintf(['- ' MONKEY{m} ,' ---\n']);
    res_fld = fullfile(data_fld, MONKEY{m},'AVG');
    %res_fld = fullfile(data_fld, MONKEY{m},'NEW');
        ...
        for sess = 1:size(SESS,2)
            ...
            for elec=1:128
                for fb = 1:5
                    ...
                    col_bl{elec,fb}=[col_bl{elec,fb}; ...
                        0]; 
                    col_bl_even{elec,fb}=[col_bl_even{elec,fb}; ...
                        0];
                    col_bl_odd{elec,fb}=[col_bl_odd{elec,fb}; ...
                        0];
                end
            end
