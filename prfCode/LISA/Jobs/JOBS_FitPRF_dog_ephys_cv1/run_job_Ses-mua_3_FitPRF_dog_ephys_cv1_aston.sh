...
# INFO: FitPRF_dog_ephys_cv1_mua_3
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_ephys.sh \
	...
	dog_ephys 1 dog_ephys_cv1 /home/pcklink/PRF/Logs/ $TMPDIR/PRF/ \
	 |& tee $TMPDIR/PRF/Logs/Log_aston_mua_3_dog_ephys_xval1.txt

cp $TMPDIR/PRF/Logs/Log_aston_mua_3_dog_ephys_xval1.txt $HOME/PRF/Logs/
exit $?
