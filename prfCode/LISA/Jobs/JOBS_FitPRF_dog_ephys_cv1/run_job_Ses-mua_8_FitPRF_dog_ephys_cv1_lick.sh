...
# INFO: FitPRF_dog_ephys_cv1_mua_8
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_ephys.sh \
	pRF_FitModel_LISA_multephys lick mua 8 [] \
	dog_ephys 1 dog_ephys_cv1 /home/pcklink/PRF/Logs/ $TMPDIR/PRF/ \
	 |& tee $TMPDIR/PRF/Logs/Log_lick_mua_8_dog_ephys_xval1.txt

cp $TMPDIR/PRF/Logs/Log_lick_mua_8_dog_ephys_xval1.txt $HOME/PRF/Logs/
exit $?
