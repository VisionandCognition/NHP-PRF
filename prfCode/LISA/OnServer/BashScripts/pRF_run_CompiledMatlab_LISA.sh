...
echo 'Path to Logfile directory: '$6
LOGFILE_DIR=$6

echo 'Path to matlab file: '$7
MATLAB_PATH=$7
...
./$MATLAB_SCRIPT $MONKEY $SESS $SLICES $NWORKERS
...
mkdir $HOME/PRF/Results/$MONKEY/$SESS
cp -r $TMPDIR/PRF/Results/$MONKEY/$SESS/Slices* $HOME/PRF/Results/$MONKEY/$SESS/
