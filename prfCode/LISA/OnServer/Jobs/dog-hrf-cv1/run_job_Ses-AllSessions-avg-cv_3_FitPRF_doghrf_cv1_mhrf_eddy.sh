...
# INFO: FitPRF_doghrf_cv1_mhrf_AllSessions-avg-cv_31:45
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg.sh \
	pRF_FitModel_LISA_cv eddy AllSessions-avg-cv 31:45 HRF_monkey [10] \
	dog_hrf 1 doghrf_cv1_mhrf /home/pcklink/PRF/Logs/ $TMPDIR/PRF/ \
	 |& tee $TMPDIR/PRF/Logs/Log_eddy_AllSessions-avg-cv_31:45_HRF_monkey_dog_hrf_xval1.txt

cp $TMPDIR/PRF/Logs/Log_eddy_AllSessions-avg-cv_31:45_HRF_monkey_dog_hrf_xval1.txt $HOME/PRF/Logs/
exit $?
