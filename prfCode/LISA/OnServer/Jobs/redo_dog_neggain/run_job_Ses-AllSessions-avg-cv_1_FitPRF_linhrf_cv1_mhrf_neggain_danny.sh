...
# INFO: FitPRF_linhrf_cv1_mhrf_neggain_AllSessions-avg-cv_01:14
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg.sh \
	pRF_FitModel_LISA_cv_neggain danny AllSessions-avg-cv 01:14 HRF_monkey [] \
	linear_hrf 1 linhrf_cv1_mhrf_neggain /home/pcklink/PRF/Logs/ $TMPDIR/PRF/ \
	 |& tee $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-cv_01:14_HRF_monkey_linear_hrf_xval1.txt

cp $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-cv_01:14_HRF_monkey_linear_hrf_xval1.txt $HOME/PRF/Logs/
exit $?
