...
# INFO: FitPRF_doghrf_cv1_mhrf_AllSessions-avg-cv_16:30
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg.sh \
	...
	dog_hrf 1 doghrf_cv1_mhrf /home/pcklink/PRF/Logs/ $TMPDIR/PRF/ \
	 |& tee $TMPDIR/PRF/Logs/Log_eddy_AllSessions-avg-cv_16:30_HRF_monkey_dog_hrf_xval1.txt

cp $TMPDIR/PRF/Logs/Log_eddy_AllSessions-avg-cv_16:30_HRF_monkey_dog_hrf_xval1.txt $HOME/PRF/Logs/
exit $?
