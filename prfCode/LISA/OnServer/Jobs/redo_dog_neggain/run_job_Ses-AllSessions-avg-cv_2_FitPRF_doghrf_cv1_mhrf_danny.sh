...
# INFO: FitPRF_doghrf_cv1_mhrf_AllSessions-avg-cv_15:28
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg.sh \
	pRF_FitModel_LISA_cv danny AllSessions-avg-cv 15:28 HRF_monkey [10] \
	dog_hrf 1 doghrf_cv1_mhrf /home/pcklink/PRF/Logs/ $TMPDIR/PRF/ \
	 |& tee $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-cv_15:28_HRF_monkey_dog_hrf_xval1.txt

cp $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-cv_15:28_HRF_monkey_dog_hrf_xval1.txt $HOME/PRF/Logs/
exit $?
