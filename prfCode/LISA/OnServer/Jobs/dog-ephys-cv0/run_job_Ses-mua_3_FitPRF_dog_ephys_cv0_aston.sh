...
# INFO: FitPRF_dog_ephys_cv0_mua_3
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_ephys.sh \
	...
	dog_ephys 0 dog_ephys_cv0 /home/pcklink/PRF/Logs/ $TMPDIR/PRF/ \
	 |& tee $TMPDIR/PRF/Logs/Log_aston_mua_3_dog_ephys_xval0.txt

cp $TMPDIR/PRF/Logs/Log_aston_mua_3_dog_ephys_xval0.txt $HOME/PRF/Logs/
exit $?
