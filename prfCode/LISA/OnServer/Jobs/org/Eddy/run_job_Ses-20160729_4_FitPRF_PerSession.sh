#PBS -S /bin/bash
#PBS -N FitPRF_PerSession_20160729_46:60
#PBS -j oe
...
echo "Job $PBS_JOBID started at `date`. Subject: eddy, Session: 20160729, Slices: 46:60" | mail $USER -s "Job $PBS_JOBID"
...
$TMPDIR/PRF/BashScripts/pRF_run_CompiledMatlab_LISA.sh \
	pRF_FitModel_LISA eddy 20160729 46:60 [6] \
	/home/pcklink/PRF/Logs/ \
	$TMPDIR/PRF/


echo "Job $PBS_JOBID ended at `date`. Subject: eddy, Session: 20160729, Slices: 46:60" | mail $USER -s "Job $PBS_JOBID"
