...
echo "Job $PBS_JOBID started at `date`. Subject: danny, Session: 20171129, Slices: 29:42" | mail $USER -s "Job $PBS_JOBID"
...
$TMPDIR/PRF/BashScripts/pRF_run_CompiledMatlab_LISA.sh \
	pRF_FitModel_LISA danny 20171129 29:42 [4] \
	/home/pcklink/PRF/Logs/ \
	$TMPDIR/PRF/


echo "Job $PBS_JOBID ended at `date`. Subject: danny, Session: 20171129, Slices: 29:42" | mail $USER -s "Job $PBS_JOBID"
