...
# INFO: FitPRF_avg_AllSessions-only_avg_29:42
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg.sh \
	pRF_FitModel_LISA_avg danny AllSessions-only_avg 29:42 HRF_monkey [] \
	/home/pcklink/PRF/Logs/ \
	$TMPDIR/PRF/ |& tee $TMPDIR/PRF/Logs/Log_danny_AllSessions-only_avg_29:42_HRF_monkey.txt

cp $TMPDIR/PRF/Logs/Log_danny_AllSessions-only_avg_29:42_HRF_monkey.txt $HOME/PRF/Logs/
exit $?
