...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg.sh \
	...
	$TMPDIR/PRF/ |& tee $TMPDIR/PRF/Logs/Log_eddy_AllSessions-avg-odd_01:15_HRF_monkey.txt

cp $TMPDIR/PRF/Logs/Log_eddy_AllSessions-avg-odd_01:15_HRF_monkey.txt $HOME/PRF/Logs/
exit $?
