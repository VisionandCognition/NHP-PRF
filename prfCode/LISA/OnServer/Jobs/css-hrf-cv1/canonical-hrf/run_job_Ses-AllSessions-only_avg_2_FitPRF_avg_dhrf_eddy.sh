...
# INFO: FitPRF_avg_dhrf_AllSessions-only_avg_16:30
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg_dhrf.sh \
	pRF_FitModel_LISA_avg eddy AllSessions-only_avg 16:30 defaultHRF [] \
	/home/pcklink/PRF/Logs/ \
	$TMPDIR/PRF/ |& tee $TMPDIR/PRF/Logs/Log_eddy_AllSessions-only_avg_16:30_defaultHRF.txt

cp $TMPDIR/PRF/Logs/Log_eddy_AllSessions-only_avg_16:30_defaultHRF.txt $HOME/PRF/Logs/
exit $?
