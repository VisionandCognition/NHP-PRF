...
# INFO: FitPRF_avg_dhrf_AllSessions-avg-odd_46:60
...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg_dhrf.sh \
	pRF_FitModel_LISA_avg eddy AllSessions-avg-odd 46:60 defaultHRF [] \
	/home/pcklink/PRF/Logs/ \
	$TMPDIR/PRF/ |& tee $TMPDIR/PRF/Logs/Log_eddy_AllSessions-avg-odd_46:60_defaultHRF.txt

cp $TMPDIR/PRF/Logs/Log_eddy_AllSessions-avg-odd_46:60_defaultHRF.txt $HOME/PRF/Logs/
exit $?
