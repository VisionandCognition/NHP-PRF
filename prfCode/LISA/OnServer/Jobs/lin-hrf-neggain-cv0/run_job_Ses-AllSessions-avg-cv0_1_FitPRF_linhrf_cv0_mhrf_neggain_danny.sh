...
$TMPDIR/PRF/BashScripts/pRF_run_analyzePRF_LISA_avg.sh \
	pRF_FitModel_LISA_cv_neggain danny AllSessions-avg-cv0 01:14 HRF_monkey [] \
	linear_hrf 0 linhrf_cv0_mhrf_neggain /home/pcklink/PRF/Logs/ $TMPDIR/PRF/ \
	 |& tee $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-cv0_01:14_HRF_monkey_linear_hrf_xval0.txt

cp $TMPDIR/PRF/Logs/Log_danny_AllSessions-avg-cv0_01:14_HRF_monkey_linear_hrf_xval0.txt $HOME/PRF/Logs/
exit $?
