...
%     using getcanonicalhrf(tr,tr)'). This is not used when 'modeltype'
%     specifies one of the ephys options.
...
%   'css_ephys' fits to ephys to a css model data without convolving the stimulus
%   'linear_ephys' fits to ephys data to a linear model without convolving the stimulus
%
    ...
    case 'dog_hrf'
        ...
        model = {[] ...
            [1-res(1)+1 1-res(2)+1  0    0   1    0; ...
             2*res(1)-1 2*res(2)-1  Inf  Inf Inf  Inf] ...
            modelfun};
