...
echo "Job $PBS_JOBID started at `date`. Subject: danny, Session: 20180124, Slices: 29:42" | mail $USER -s "Job $PBS_JOBID"
...
echo "Job $PBS_JOBID ended at `date`. Subject: danny, Session: 20180124, Slices: 29:42" | mail $USER -s "Job $PBS_JOBID"
