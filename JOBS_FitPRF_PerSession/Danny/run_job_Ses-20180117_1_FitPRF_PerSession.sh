...
echo "Job $PBS_JOBID started at `date`. Subject: danny, Session: 20180117, Slices: 01:14" | mail $USER -s "Job $PBS_JOBID"
...
$TMPDIR/PRF/BashScripts/pRF_run_CompiledMatlab_LISA.sh \
	pRF_FitModel_LISA danny 20180117 01:14 [8] \
	/home/pcklink/PRF/Logs/ \
	$TMPDIR/PRF/


echo "Job $PBS_JOBID ended at `date`. Subject: danny, Session: 20180117, Slices: 01:14" | mail $USER -s "Job $PBS_JOBID"
