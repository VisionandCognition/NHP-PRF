#PBS -S /bin/bash
#PBS -N FitPRF_PerSession_20171207_01:14
#PBS -j oe
...
echo "Job $PBS_JOBID started at `date`. Subject: danny, Session: 20171207, Slices: 01:14" | mail $USER -s "Job $PBS_JOBID"
...
$TMPDIR/PRF/BashScripts/pRF_run_CompiledMatlab_LISA.sh \
	pRF_FitModel_LISA danny 20171207 01:14 [] \
	/home/pcklink/PRF/Logs/ \
	$TMPDIR/PRF/


echo "Job $PBS_JOBID ended at `date`. Subject: danny, Session: 20171207, Slices: 01:14" | mail $USER -s "Job $PBS_JOBID"
