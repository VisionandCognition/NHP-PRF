...
echo "Job $PBS_JOBID started at `date`. Subject: danny, Session: 20171116, Slices: 43:56" | mail $USER -s "Job $PBS_JOBID"
...
echo "Job $PBS_JOBID ended at `date`. Subject: danny, Session: 20171116, Slices: 43:56" | mail $USER -s "Job $PBS_JOBID"
