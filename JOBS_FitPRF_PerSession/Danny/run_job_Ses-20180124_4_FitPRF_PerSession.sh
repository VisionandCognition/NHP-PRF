#PBS -S /bin/bash
#PBS -N FitPRF_PerSession_20180124_43:56
#PBS -j oe
...
echo "Job $PBS_JOBID started at `date`. Subject: danny, Session: 20180124, Slices: 43:56" | mail $USER -s "Job $PBS_JOBID"
...
$TMPDIR/PRF/BashScripts/pRF_run_CompiledMatlab_LISA.sh \
	pRF_FitModel_LISA danny 20180124 43:56 [] \
	/home/pcklink/PRF/Logs/ \
	$TMPDIR/PRF/


echo "Job $PBS_JOBID ended at `date`. Subject: danny, Session: 20180124, Slices: 43:56" | mail $USER -s "Job $PBS_JOBID"
