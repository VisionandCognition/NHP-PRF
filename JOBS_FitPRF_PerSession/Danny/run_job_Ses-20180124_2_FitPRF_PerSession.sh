...
echo "Job $PBS_JOBID started at `date`. Subject: danny, Session: 20180124, Slices: 15:28" | mail $USER -s "Job $PBS_JOBID"
...
echo "Job $PBS_JOBID ended at `date`. Subject: danny, Session: 20180124, Slices: 15:28" | mail $USER -s "Job $PBS_JOBID"
