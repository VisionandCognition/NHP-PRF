...
echo "Job $PBS_JOBID started at `date`. Subject: danny, Session: 20180201, Slices: 01:14" | mail $USER -s "Job $PBS_JOBID"
...
echo "Job $PBS_JOBID ended at `date`. Subject: danny, Session: 20180201, Slices: 01:14" | mail $USER -s "Job $PBS_JOBID"
