#PBS -S /bin/bash
#PBS -N FitPRF_PerSession_20180131_15:28
#PBS -j oe
...
echo "Job $PBS_JOBID started at `date`. Subject: danny, Session: 20180131, Slices: 15:28" | mail $USER -s "Job $PBS_JOBID"
...
$TMPDIR/PRF/BashScripts/pRF_run_CompiledMatlab_LISA.sh \
	pRF_FitModel_LISA danny 20180131 15:28 [] \
	/home/pcklink/PRF/Logs/ \
	$TMPDIR/PRF/


echo "Job $PBS_JOBID ended at `date`. Subject: danny, Session: 20180131, Slices: 15:28" | mail $USER -s "Job $PBS_JOBID"
