#PBS -S /bin/bash
#PBS -N FitPRF_PerSession_20170518_16:30
#PBS -j oe
...
echo "Job $PBS_JOBID started at `date`. Subject: eddy, Session: 20170518, Slices: 16:30" | mail $USER -s "Job $PBS_JOBID"
...
$TMPDIR/PRF/BashScripts/pRF_run_CompiledMatlab_LISA.sh \
	pRF_FitModel_LISA eddy 20170518 16:30 [] \
	/home/pcklink/PRF/Logs/ \
	$TMPDIR/PRF/


echo "Job $PBS_JOBID ended at `date`. Subject: eddy, Session: 20170518, Slices: 16:30" | mail $USER -s "Job $PBS_JOBID"
